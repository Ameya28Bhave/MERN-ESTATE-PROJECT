    ...
    <div className='flex flex-col md:flex-row'>
        <div className='p-7 border-b-2 md:border-r-2 md:min-h-screen'>
            <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
                ...
                <button className='bg-slate-700 text-white p-3 uppercase rounded-lg hover:95'>Search</button>
            </form>
        </div>
        <div className='flex-1'>
            ...
            <div className='p-7 flex flex-wrap gap-4'>
                ...
                {showmMore && (
                    <button onClick={onShowMoreClick} className = 'text-grenn-700 hover:underline p-7 text-center w-full'>Show More</button>
                )}
            </div>
        </div>
    </div>
